...
const paymentsData = ref<PaymentDataItem[]>([
  ...
  {
    id: 2, title: '192-03-147 SOD', duedate: '2025-06-03', amount: 336600, paid: 245000, paymentHistory: [
  ...
  {
    id: 4, title: '192-03-147 Odchylka', duedate: '2025-08-03', amount: 45000, paid: 32000, paymentHistory: [
  ...
  {
    id: 6, title: '192-03-147 dopLPZ', duedate: '2025-10-29', amount: 45000, paid: 32000, paymentHistory: [
      { id: 6001, date: '2025-08-21', amount: 32000, voucher: 'Věrnostní poukázka' },
    ],
  },
  {
  ...
  {
    id: 8, title: 'Modernizace výtahu', duedate: '2026-06-01', amount: 45000, paid: 32000, paymentHistory: [
  ...
  {
    id: 10, title: 'Revize elektroinstalace', duedate: '2024-01-01', amount: 50000, paid: 50000, paymentHistory: [
      { id: 10001, date: '2023-12-15', amount: 25000 },
      { id: 10002, date: '2023-12-28', amount: 25000 },
    ],
  },
  {
    id: 11, title: 'Nové vchodové dveře', duedate: '2025-08-03', amount: 50000, paid: 50000, isInvoiceShown: true, paymentHistory: [
      { id: 11001, date: '2025-07-25', amount: 50000 },
    ],
  },
  {
    id: 12, title: 'Instalace mučící komory', duedate: 'lkdahgiurn', amount: 15301, paid: 50000, paymentHistory: [
      { id: 12001, date: '2025-08-11', amount: 15301 },
    ],
  },
  {
    id: 13, title: 'Odklid mrtvol', duedate: '2024-01-01', amount: 14873, paid: 140000, paymentHistory: [
      { id: 13001, date: '2023-10-11', amount: 14873 },
    ],
  },
  {
    id: 14, title: '192-03-147 dopl.BD', duedate: '2025-05-11', amount: 45000, paid: 45000, paymentHistory: [
