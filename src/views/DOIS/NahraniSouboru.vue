              ...
              <!-- <div class="dz-default dz-message">
                <button class="dz-button" type="button">
                  <span class="d-none d-lg-inline">
                    ...
                    Přetáhněte soubory nebo kliknutím vyberte
                  </span>
                  <span class="d-lg-none">Kliknutím vyberte soubory k nahrání</span>
                </button>
              </div> -->
              <!-- * Custom markup (utilizing our Empty component) -->
            ...
            <div class="row align-items-baseline">
              ...
              <div class="col-auto">
                <div class="btn-list">
                  ...
                  <!-- NOTE: Button bude disabled dokud nebude vybrán dodavatel a nebude v dropzone nějaký soubor -->
                  <button type="submit" class="btn btn-primary" disabled>Nahrát</button>
                </div>
              </div>
            </div>
