    ...
    <div class="container-xl">
      ...
      <div class="navbar-nav flex-row order-md-last">
        <div class="d-none d-md-flex align-items-center me-3">
          ...
          <div class="nav-item">
            <a href="#" class="nav-link px-0" onclick="event.preventDefault(); document.querySelector('#temp-search')?.showModal()" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Vyhledat">
          ...
          <div class="nav-item">
            <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zapnout tmavý režim" onclick="applyTheme('dark')">
              <!-- Download SVG icon from http://tabler.io/icons/icon/moon -->
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
                <path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z"></path>
              </svg>
            </a>
            <a href="?theme=light" class="nav-link px-0 hide-theme-light" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zapnout světlý režim" onclick="applyTheme('light')">
          ...
          <!-- TEMP - HIDDEN BUT KEPT FOR NOW -> delete? -->
          <div class="nav-item dropdown d-none d-md-flex" hidden>
