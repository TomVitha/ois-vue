  ...
  <div class="navbar-nav flex-row order-lg-last ms-auto">
    <div class="d-flex align-items-center">
      ...
      <div class="nav-item">
        ...
        <button class="nav-link px-0 hide-theme-light" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zapnout světlý režim" @click.prevent="themeStore.applyTheme('light')">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
      ...
      <!-- Messenger -->
      <div class="nav-item">
        <RouterLink to="/komunikace" class="nav-link px-0 text-body" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Komunikace">
          <!-- mail -->
          ...
          <span v-if="messengerStore.unreadCount > 0" class="badge bg-red text-red-fg badge-sm">{{ messengerStore.unreadCount }}</span>
        </RouterLink>
      </div>
      <!-- User -->
